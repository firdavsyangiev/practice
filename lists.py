...
letters = ["a", "d", "b"]
letters.append("c")  # add end of list
...
size = len(letters) - 1
result1 = letters.pop(size)  # remove last element
print(f"the pop result1: {result1} and letters: {letters}")

result2 = letters.pop(0)  # remove first element
...
# exist2 = animals.index("cat")  # ERROR
# print("the exist2:", exist2)
